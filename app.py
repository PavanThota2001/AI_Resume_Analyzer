...
st.title("📄 Pavan's Resume Analyzer")
st.write("Upload your resume and type a description to analyze.")
...
with col2:
	job_description = st.text_area("Enter Description",placeholder="Paste the Job description here")
...
if analyze_button and uploaded_file and job_description:
    ...
    if resume_text:
        # Generate analysis
        with st.spinner("Resume being Analyzed..."):
